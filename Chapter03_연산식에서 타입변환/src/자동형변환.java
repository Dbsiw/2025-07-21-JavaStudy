 ...
 *
 *		입출력 => 69페이지
 *		System.out.printIn(): 가장많이 사용
 *		---------------------> 웹 => 입력값 확인, 오류 메세지 출력
 *		사용을 하면 => 줄바꿈
 *		System.out.print(): 문법 사항 => 줄바꿈이 안된다
 *							가로로 출력 => 한명에 대한 데이터 출력
 *		System.out.printf(): 출력 서식으 만들어서 출력
 *		-------------------- C언어에서 주로 사용
 *		Printf("서식",값...)
 *			   -----
 *				정수값 :  %d
...
public class 자동형변환 {
	...
	public static void main(String[] args) {
		/*
		 * // TODO Auto-generated method stub //자동형변환 aa=new 자동형변환(); //b=new 자동형변환();
		 * //System.out.println(aa); //System.out.println(b); 자동형변환 b=new 자동형변환();
		 * double d=10; //10.0 System.out.println(d); int a=(int)d;
		 * System.out.println(a);
		 * 
		 * byte b1=10; byte b2=20; // 오류 byte b3=b1+b2; byte 대신 int / long/ double /
		 * float int b3=b1+b2; //가 정답 System.out.printf("%3d%3d%3d",10,20,30);
		 * System.out.printf("%3d%3d%3d\n",10,20,30);
		 * System.out.printf("%.2f\n",10/3.0); System.out.printf("%.1f\n",10/3.0); //소수점
		 * System.out.printf("%02d\n",12); System.out.printf("%c\n",'A');
		 * System.out.printf("%s\n","홍길동"); System.out.println(10 +" "+20+" "+30+" ");
		 */
//		byte b1=10;
//		byte b2=20;
//		int b3=b1+b2;
